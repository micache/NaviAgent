...
class ReceptionistAgent(Agent):
    ...
    def __init__(self):
        super().__init__(
            ...
            3. If the customer did not provide a destination, suggest one based on their preferences
            4. Once got the destination, ask customer about other information needed for the trip planning in this order:
               - Length of stay
               - Number of guests
               - Budget
               - Interests
            ...
            6. When ALL required information is collected (departure, destination, length_of_stay, number_of_guests, budget, interests, and personal_requirements ASKED and answered), STOP asking questions
