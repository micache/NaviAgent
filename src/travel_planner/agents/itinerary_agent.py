...
def create_itinerary_agent(
    ...
    return Agent(
        ...
        instructions=[
            ...
            "**Step A: Budget Calculation (MANDATORY)**:",
            ...
            "   • If any cost info comes in USD, convert to VND first (1 USD ≈ 26,500 VND)",
            ...
            "   • This 'daily_spending_limit' is PER PERSON and guides all 'estimated_cost' for activities.",
            "",
            "**Step B: Search Strategy (Max 10 searches)**:",
