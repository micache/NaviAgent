...
def main():
    ...
    print("   Example: create_weather_agent('weather') instead of create_weather_agent('gpt-4o-mini')")
    print("3. Test with: cd src/travel_planner && uv run python -c \"from config import model_settings; model_settings.print_config_summary()\"")
