...
class OrchestratorAgent:
    ...
    async def plan_trip(self, request: TravelRequest) -> TravelPlan:
        ...
        itinerary_result = results_phase1[0] if not isinstance(results_phase1[0], Exception) else None
        logistics_result = results_phase1[1] if not isinstance(results_phase1[1], Exception) else None
        souvenir_result = results_phase1[2] if not isinstance(results_phase1[2], Exception) else None
        ...
        advisory_result = results_phase2[1] if not isinstance(results_phase2[1], Exception) else None
    ...
    def _compile_travel_plan(
        ...
        souvenir_suggestions = [
            SouvenirSuggestion(**item) if isinstance(item, dict) else item
