...
def create_budget_agent(
    ...
    return Agent(
        ...
        instructions=[
            ...
            "   - IMPORTANT: All 'estimated_cost' values should already be in VND from ItineraryAgent.",
            "   - If you encounter costs in other currencies (USD, KRW, JPY, etc.), FLAG this as an error.",
            ...
            "   - Get 'cost' = activity.estimated_cost (this should be per person in VND)",
