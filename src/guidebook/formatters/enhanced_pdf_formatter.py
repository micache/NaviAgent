<<<<<<< HEAD:src/guidebook/formatters/enhanced_pdf_formatter.py
"""
PDF formatter for guidebook generation using ReportLab.

<<<<<<<< HEAD:src/guidebook/formatters/enhanced_pdf_formatter.py
=======
"""Enhanced PDF formatter using WeasyPrint for professional guidebook generation."""

>>>>>>> f6e7ca1c64ab97b611592d67f26ea68822141681:src/travel_planner/guidebook/formatters/enhanced_pdf_formatter.py
...
<<<<<<< HEAD:src/guidebook/formatters/enhanced_pdf_formatter.py
========
This module generates professional PDF guidebooks with:
- Vietnamese character support via built-in fonts
- Clean, printable layouts
- Cover page, table of contents, and sections
"""
>>>>>>>> f6e7ca1c64ab97b611592d67f26ea68822141681:src/travel_planner/guidebook/formatters/pdf_formatter.py
...
>>>>>>> f6e7ca1c64ab97b611592d67f26ea68822141681:src/travel_planner/guidebook/formatters/enhanced_pdf_formatter.py
class EnhancedPDFFormatterBase(ABC):
    """Abstract base class for enhanced PDF formatters.

    This is a standalone base class for advanced PDF formatters that use
    a different interface (format method takes data parameter).
    """
...
class EnhancedPDFFormatter(EnhancedPDFFormatterBase):
