...
class ReceptionistAgent(Agent):
    ...
    def _validate_date(self, date_str: str) -> tuple[bool, Optional[str]]:
        ...
        try:
            ...
            if parsed_date.date() <= today.date():
                return (
                    False,
                    "The travel date must be in the future. Please provide a date after today.",
                )
            ...
            return (
                False,
                "I couldn't understand that date. Please provide a valid date (e.g., 'December 25th' or '25/12/2025').",
            )
    ...
    def _validate_number(self, num_str: str) -> tuple[bool, Optional[str], Optional[int]]:
        ...
        try:
            ...
            if num <= 0:
                return (
                    False,
                    "The number of guests must be at least 1. Please provide a valid number.",
                    None,
                )
            if num > 100:
                return (
                    False,
                    "That seems like a very large group! Please provide a reasonable number (1-100).",
                    None,
                )
        ...
        try:
            ...
            return (
                False,
                "I couldn't find a valid number in your response. Please provide the number of guests (e.g., '2', 'two', or '2 people').",
                None,
            )
    ...
    def _validate_budget(self, budget_str: str) -> tuple[bool, Optional[str]]:
        ...
        if "YES" in response:
            ...
            return (
                False,
                "Please provide your budget as a monetary amount (e.g., '1000 USD', '20 million VND', or '$500').",
            )
    ...
    def collect_special_notes(self, notes: str) -> str:
        ...
        """
        self.travel_data["special_notes"] = (
            notes if notes.lower() not in ["no", "none", "nothing"] else "None"
        )
    ...
    def handle_confirmation(self, response: str) -> str:
        ...
        if any(
            ...
            for word in ["yes", "correct", "looks good", "perfect", "right", "ok", "okay", "good"]
        ):
