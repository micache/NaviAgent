...
def main():
    ...
    parser.add_argument("--data", type=str, default=str(config.paths.data_path),
                       help="Path to CSV file")
    parser.add_argument("--collection", type=str, default=config.index.collection_name,
                       help="Collection name")
    parser.add_argument("--batch-size", type=int, default=config.index.batch_size,
