...
def main():
    ...
    parser.add_argument("--top-k", type=int, default=config.search.top_k, help="Number of results")
    parser.add_argument(
        "--collection", type=str, default=config.search.collection_name, help="Collection name"
    )
    parser.add_argument(
        "--group",
        action="store_true",
