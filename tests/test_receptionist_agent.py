...
import pytest
from reception.receptionist_agent import ReceptionistAgent, ConversationState
...
class TestConversationState:
    ...
    def test_conversation_states_exist(self):
        ...
        expected_states = [
            'GREETING', 'ASK_DESTINATION', 'SUGGEST_DESTINATION',
            'COLLECT_DEPARTURE', 'COLLECT_TRAVEL_DATE', 'COLLECT_LENGTH_OF_STAY',
            'COLLECT_NUM_GUESTS', 'COLLECT_BUDGET', 'COLLECT_TRAVEL_STYLE',
            'COLLECT_NOTES', 'CONFIRM_DETAILS', 'UPDATE_DETAILS', 'COMPLETED'
        ]
